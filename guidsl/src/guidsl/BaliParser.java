...
//-----------------------------------//
  static final public 
Model Model() throws ParseException {Cons co0=null ;
    Prods pr0=null ;
    Vars va0=null ;
    pr0 = Prods();
...
{if ("" != null) return new MainModel().setParms (pr0, opt(co0), opt(va0)) ;}
    throw new Error("Missing return statement in function");
  }

  static final public AExpr AExpr() throws ParseException {AExpr ae0=null ;
    NExpr ne0=null ;
    Token to0=null ;
    ...
    if (jj_2_1(2)) {
      ...
      ae0 = AExpr();
{if ("" != null) return new BAnd().setParms (ne0, t2at(to0), ae0) ;}
    } else {
      ;
    }
{if ("" != null) return (AExpr) ne0 ;}
    throw new Error("Missing return statement in function");
  }

  static final public Avar Avar() throws ParseException {Opts op0=null ;
...
{if ("" != null) return new Var().setParms (t2at(to0), t2at(to1), opt(op0), t2at(to2)) ;}
    throw new Error("Missing return statement in function");
  }

  static final public AvarList AvarList() throws ParseException {AvarList list = new AvarList () ;
    Avar av0=null ;
    label_1:
    while (true) {
      av0 = Avar();
...
{if ("" != null) return list ;}
  ...
  static final public BExpr BExpr() throws ParseException {Expr ex0=null ;
    Token to1=null, to0=null ;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENTIFIER:{
      to0 = jj_consume_token(IDENTIFIER);
{if ("" != null) return new Bvar().setParms (t2at(to0)) ;}
      break;
      }
    case 19:{
...
{if ("" != null) return new Paren().setParms (t2at(to0), ex0, t2at(to1)) ;}
      break;
      }
    default:
      jj_la1[4] = jj_gen;
  ...
  static final public Cons Cons() throws ParseException {ESList es0=null ;
    Token to0=null ;
    to0 = jj_consume_token(21);
    es0 = ESList();
{if ("" != null) return new ConsStmt().setParms (t2at(to0), es0) ;}
    throw new Error("Missing return statement in function");
  }

  static final public EExpr EExpr() throws ParseException {EExpr ee0=null ;
    IExpr ie0=null ;
    Token to0=null ;
    ...
    if (jj_2_2(2)) {
      ...
      ee0 = EExpr();
{if ("" != null) return new BIff().setParms (ie0, t2at(to0), ee0) ;}
    } else {
      ;
    }
{if ("" != null) return (EExpr) ie0 ;}
    throw new Error("Missing return statement in function");
  }

  static final public ESList ESList() throws ParseException {ESList list = new ESList () ;
    ExprStmt ex0=null ;
    label_2:
    while (true) {
      ex0 = ExprStmt();
...
{if ("" != null) return list ;}
  ...
  static final public Expr Expr() throws ParseException {EExpr ee0=null ;
    ExprList ex0=null ;
    Token to2=null, to1=null, to0=null ;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 23:{
...
{if ("" != null) return new BChoose1().setParms (t2at(to0), t2at(to1), ex0, t2at(to2)) ;}
      break;
      }
    case 19:
    case 33:
...
{if ("" != null) return (Expr) ee0 ;}
  ...
  static final public ExprList ExprList() throws ParseException {ExprList list = new ExprList () ;
    EExpr ee0=null ;
    Token to0=null ;
    ee0 = EExpr();
...
{if ("" != null) return list ;}
  ...
  static final public ExprStmt ExprStmt() throws ParseException {Expr ex0=null ;
...
{if ("" != null) return new EStmt().setParms (ex0, t2at(to0)) ;}
      break;
      }
    case 26:{
...
{if ("" != null) return new VarDef().setParms
  ...
  static final public GProd GProd() throws ParseException {Pats pa0=null ;
    Token to2=null, to1=null, to0=null ;
    to0 = jj_consume_token(IDENTIFIER);
    to1 = jj_consume_token(27);
    pa0 = Pats();
    to2 = jj_consume_token(25);
{if ("" != null) return new GProduction().setParms
    (t2at(to0), t2at(to1), pa0, t2at(to2)) ;}
    throw new Error("Missing return statement in function");
  }

  static final public GTerm GTerm() throws ParseException {Token to2=null, to1=null, to0=null ;
    if (jj_2_3(2)) {
      to0 = jj_consume_token(IDENTIFIER);
      to1 = jj_consume_token(28);
{if ("" != null) return new PlusTerm().setParms (t2at(to0), t2at(to1)) ;}
    } else if (jj_2_4(2)) {
      to0 = jj_consume_token(IDENTIFIER);
      to1 = jj_consume_token(29);
{if ("" != null) return new StarTerm().setParms (t2at(to0), t2at(to1)) ;}
    } else {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case IDENTIFIER:{
        to0 = jj_consume_token(IDENTIFIER);
{if ("" != null) return new TermName().setParms (t2at(to0)) ;}
        break;
        }
      case 30:{
...
{if ("" != null) return new OptTerm().setParms (t2at(to0), t2at(to1), t2at(to2)) ;}
        break;
        }
      default:
        jj_la1[9] = jj_gen;
  ...
  static final public IExpr IExpr() throws ParseException {IExpr ie0=null ;
    OExpr oe0=null ;
    Token to0=null ;
    ...
    if (jj_2_5(2)) {
      ...
      ie0 = IExpr();
{if ("" != null) return new BImplies().setParms (oe0, t2at(to0), ie0) ;}
    } else {
      ;
    }
{if ("" != null) return (IExpr) oe0 ;}
    throw new Error("Missing return statement in function");
  }

  static final public NExpr NExpr() throws ParseException {BExpr be0=null ;
    NExpr ne0=null ;
    Token to0=null ;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 19:
    case IDENTIFIER:{
      be0 = BExpr();
{if ("" != null) return (NExpr) be0 ;}
      break;
      }
    case 33:{
      to0 = jj_consume_token(33);
      ne0 = NExpr();
{if ("" != null) return new BNot().setParms (t2at(to0), ne0) ;}
      break;
      }
    default:
      jj_la1[10] = jj_gen;
  ...
  static final public OExpr OExpr() throws ParseException {AExpr ae0=null ;
    OExpr oe0=null ;
    Token to0=null ;
    ...
    if (jj_2_6(2)) {
      ...
      oe0 = OExpr();
{if ("" != null) return new BOr().setParms (ae0, t2at(to0), oe0) ;}
    } else {
      ;
    }
{if ("" != null) return (OExpr) ae0 ;}
    throw new Error("Missing return statement in function");
  }

  static final public Opt Opt() throws ParseException {Token to2=null, to1=null, to0=null ;
    if (jj_2_7(2)) {
      to0 = jj_consume_token(IDENTIFIER);
      to1 = jj_consume_token(35);
      to2 = jj_consume_token(STRING_LITERAL);
{if ("" != null) return new Strlit().setParms (t2at(to0), t2at(to1), t2at(to2)) ;}
    } else {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case IDENTIFIER:{
        to0 = jj_consume_token(IDENTIFIER);
{if ("" != null) return new Optid().setParms (t2at(to0)) ;}
        break;
        }
      default:
        jj_la1[11] = jj_gen;
  ...
  static final public Opts Opts() throws ParseException {Opts list = new Opts () ;
    Opt op0=null ;
    label_4:
    while (true) {
      op0 = Opt();
...
{if ("" != null) return list ;}
  ...
  static final public Pat Pat() throws ParseException {TermList te0=null ;
    Token to1=null, to0=null ;
    if (jj_2_8(2)) {
      te0 = TermList();
      to0 = jj_consume_token(36);
      to1 = jj_consume_token(IDENTIFIER);
{if ("" != null) return new GPattern().setParms (te0, t2at(to0), t2at(to1)) ;}
    } else {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case IDENTIFIER:{
        to0 = jj_consume_token(IDENTIFIER);
{if ("" != null) return new SimplePattern().setParms (t2at(to0)) ;}
        break;
        }
      default:
        jj_la1[13] = jj_gen;
  ...
  static final public Pats Pats() throws ParseException {Pats list = new Pats () ;
    Pat pa0=null ;
    Token to0=null ;
    pa0 = Pat();
...
{if ("" != null) return list ;}
  ...
  static final public Prods Prods() throws ParseException {Prods list = new Prods () ;
    GProd gp0=null ;
    label_6:
    while (true) {
      gp0 = GProd();
...
{if ("" != null) return list ;}
  ...
  static final public TermList TermList() throws ParseException {TermList list = new TermList () ;
    GTerm gt0=null ;
    label_7:
    while (true) {
      gt0 = GTerm();
...
{if ("" != null) return list ;}
  ...
  static final public Vars Vars() throws ParseException {AvarList av0=null ;
    Token to0=null ;
    to0 = jj_consume_token(38);
    av0 = AvarList();
{if ("" != null) return new VarStmt().setParms (t2at(to0), av0) ;}
    throw new Error("Missing return statement in function");
  }
