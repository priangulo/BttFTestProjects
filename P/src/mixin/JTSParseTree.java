...
public class JTSParseTree {
    ...
    public final void preprocessTree$$CommonBase( AST_Program root ) throws Exception {
if (R4Feature.CommonBase) {
    ...
    public final void preprocessTree$$CommonError( AST_Program root ) throws Exception {
if (R4Feature.CommonError) {
    ...
    public final void preprocessTree$$LocalId( AST_Program root ) throws Exception {
...
if (R4Feature.LocalId) {
    ...
    public void preprocessTree$$AspectDecl( AST_Program root ) throws Exception {
