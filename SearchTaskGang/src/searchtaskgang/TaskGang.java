 ...
 */
public abstract class TaskGang<String> implements Runnable {
    /**
     ...
     */
    protected List<String> setInput(List<String> input) {
        return mInput = input;
    }
     ...
     */
    protected abstract List<String> getNextInput();
     ...
     */
    protected abstract boolean processInput(String inputData);
