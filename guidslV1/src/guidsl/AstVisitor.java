...
public abstract class AstVisitor extends Dispatcher {
    ...
    /**
     * A generic method that dispatches <code>this</code> to the list elements,
    ...
    /**
     * A generic method that dispatches <code>this</code> to its children, thus
     * implementing a pre-order visitation of the tree.
     *
     * @layer<visitor>
     */
