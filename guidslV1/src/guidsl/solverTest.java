...
public class solverTest {
    ...
    public static final void main$$dsl$guidsl$solver(String args[]) {
        if (args.length != 1) {
    ...
    public static void main(String args[]) {
        ...
        main$$dsl$guidsl$solver(args);
    }

    /**
     * ******************* Function creates a _debug.cnf file, an input for the
     * Model Checker SPIN****************
     */
                    ...
                    default:
                        if ((pLine[0].charAt(0) != 'c') && (pLine[0].charAt(0) != 'p') && (pLine.length > 2)) {
                            ...
                            for (int i = 0; i < pLine.length - 1; i++) {
                                ...
                                /**
                                 * ***** for each term in the predicate do the
                                 * following ********
                                 */
                                for (int j = 0; j < pLine.length - 1; j++) {
                                    ...
                                    if (j != i) {
                                        ...
                                        if (i != pLine.length - 1 - 1) {
                                            if (j != pLine.length - 1 - 1) {
                                                term += " && ";
                                            }
                                        } else if (j != pLine.length - 3) {
                                            term += " && ";
                                        }
