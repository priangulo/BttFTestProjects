 ...
 * determine the most specific runtime method signature appropriate for visiting
 * an object. This avoids the use of double-dispatch which is fairly intrusive.
 *
 * @layer<visitor>
 */
public abstract class Dispatcher {
    ...
    /**
     * Using reflection, this method calls a specific <code>visit</code> method
     * based on dynamic argument type.
     *
     * @throws IllegalStateException if trying to dispatch to <code>visit</code>
     * causes an exception (the original exception is saved as the "cause").
     *
     * @layer<visitor>
     */
    ...
    /**
     * This <code>visit</code> method is for the case where an exception occurs
     * while trying to visit an object. This can occur in the <code>visit</code>
     * method during reflection and a derived method may also call this method
    ...
    /**
     * Implements a search for a {@link Method} named <code>visit</code> with an
     * argument matching one of the superclasses of the argument. Has a cache
     * for to reduce extra searches.
     *
     * @param baseClass a non-null reference to the {@link Class} of an object
     * to visit.
     *
     * @layer<visitor>
     */
