...
public abstract class TaskGang<URL> implements Runnable {
     ...
     */
    protected List<URL> setInput(List<URL> input) {
        return mInput = input;
    }
     ...
     */
    protected abstract List<URL> getNextInput();
     ...
     * continuing to run).
     */
    protected abstract boolean processInput(URL inputData);
        ...
        return new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    // this index.
                	URL element = getInput().get(index);
